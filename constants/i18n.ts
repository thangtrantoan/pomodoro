...
const en = {
  ...
  timer: {
    ...
    sessionsDone: (n: number) => (n === 1 ? '1 session done' : `${n} sessions done`),
  },
  break: {
    kicker: 'Break',
  ...
  settings: {
    ...
    autoBreak: 'Start the break automatically',
    autoBreakHint: 'A focus session rolls straight into its break, skipping the summary',
    chime: 'End chime',
    chimeHint: 'A single tone, no voice',
    ongoing: 'Lock screen timer',
    ongoingHint: 'An ongoing notification while you focus',
    ongoingHintMusic: 'Background music is on — the player notification takes this slot',
    keepAwake: 'Keep screen awake',
    keepAwakeHint: "Screen won't sleep while a session is running",
    notifBlocked: 'Notifications are blocked',
    notifBlockedHint:
      'The end chime still plays while the app is open. To be told with the screen locked, allow notifications. Tap to open system settings.',
    language: 'Language',
...
const vi: typeof en = {
  ...
  timer: {
    ...
    sessionsDone: (n: number) => `${n} phiên đã xong`,
  },
  break: {
    kicker: 'Nghỉ',
    kickerLong: 'Nghỉ dài',
  ...
  settings: {
    ...
    autoBreak: 'Tự bắt đầu phiên nghỉ',
    autoBreakHint: 'Hết phiên tập trung là vào nghỉ luôn, bỏ qua màn tổng kết',
    ...
    ongoingHintMusic: 'Nhạc nền đang bật — thông báo của trình phát đã thay chỗ',
    keepAwake: 'Giữ sáng màn hình',
    keepAwakeHint: 'Màn hình không tự tắt khi đang chạy phiên',
    notifBlocked: 'Thông báo đang bị chặn',
    notifBlockedHint:
      'Chuông vẫn kêu khi app đang mở. Muốn được báo lúc khoá màn hình thì phải cho phép thông báo. Chạm để mở cài đặt hệ thống.',
    language: 'Ngôn ngữ',
